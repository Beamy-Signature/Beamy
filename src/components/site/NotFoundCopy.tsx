...
export function NotFoundCopy() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-5 text-center">
      ...
      <h1 className="editorial-title mt-4 text-[2.25rem] sm:text-5xl">This page is not in the collection.</h1>
      ...
      <div className="mt-8 flex w-full max-w-sm flex-col gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:justify-center">
        <Link href="/" className="border border-ink bg-ink px-5 py-3 text-center text-[11px] tracking-[0.18em] text-paper uppercase">
          Return home
        </Link>
        <Link href="/collections" className="border border-ink px-5 py-3 text-center text-[11px] tracking-[0.18em] uppercase">
          Browse collections
        </Link>
      </div>
    </div>

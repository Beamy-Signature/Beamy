...
create policy "admin write collections" on public.collections for all to authenticated using (true) with check (true);
...
create policy "admin write product images" on public.product_images for all to authenticated using (true) with check (true);
...
create policy "admin write hero" on public.hero_images for all to authenticated using (true) with check (true);
